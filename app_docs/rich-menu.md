...
┌───────────────┬───────────────┬───────────────┐
│               │               │               │
│   回報時間     │   我要回報     │  查看本週數據  │  y=0, h=843
│   0, 0        │   833, 0      │   1667, 0     │
│   833x843     │   834x843     │   833x843     │
│               │               │               │
├───────────────┼───────────────┼───────────────┤
│               │               │               │
│  本週已回報    │  本週未回報    │   雲端總覽    │  y=843, h=843
...
| 區塊 | Bounds | Action |
|------|--------|--------|
| 回報時間 | x:0, y:0, w:833, h:843 | `action=show_report_time` |
| 我要回報 | x:833, y:0, w:834, h:843 | `action=start_report` |
| 查看本週數據 | x:1667, y:0, w:833, h:843 | `action=view_my_summary` |
| 本週已回報 | x:0, y:843, w:833, h:843 | `action=view_reported_list` |
| 本週未回報 | x:833, y:843, w:834, h:843 | `action=view_not_reported` |
| 雲端總覽 | x:1667, y:843, w:833, h:843 | `action=open_sheet` |
